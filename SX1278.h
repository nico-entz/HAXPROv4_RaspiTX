...
public:
    ...
    void onRxDone(void (*ptrFuncRX)(char*, int8_t, int, float));
...
private:
    ...
    void (*callback_Rx)(char*, int8_t, int, float); // pointeur sur une fonction callback utilisateur de type void(char*,int,float)
